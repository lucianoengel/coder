...
export const AgentRetrySchema = z.object({
  ...
  retryDelayMs: z.number().int().min(0).default(5000),
...
export const CoderConfigSchema = z.object({
  ...
  agents: z
    .object({
      geminiApiEndpoint: z.string().optional(),
      anthropicApiEndpoint: z.string().optional(),
...
export function migrateConfig(raw) {
  ...
  // Migrate agents endpoints into models; preserve retry/fallback keys
